        ...
        <div className = "mx-[2.5%] m-auto my-12 block md:hidden">
            ...
            <div className = 'w-full h-fit bg-gray-100 rounded-[1.5rem]  border-2 border-[#6A747B] '>
                ...
                <div className = 'my-5 mx-[5%]'>
                    ...
                    <p>黑客組：全台大專院校生及碩博生，每隊至少需有一人具備使用企業資源的能力。 </p>
                    <p>創客交流組：高中職、大專院校生及碩博生、社會人士皆可報名，參賽者需於 比賽 Demo 時讓評審實際操作作品。（參考工具：Figma、Miro、Webflow、Sketch ⋯）</p>
                </div>
                <div className = 'my-5 mx-[5%]'>
                    <h5 className = 'mb-3'>報名方式</h5>
                    <p>自行組隊報名，每隊 3~5 人，梅竹黑客松提供 <a href="https://www.facebook.com/groups/mchackathon.club.2.0/" className ='font-bold underline underline-offset-2'>臉書媒合社群</a> 供大家找隊友</p>
                ...
                <div className = 'my-5 mx-[5%]'>
                    ...
                    <p>得獎隊伍需要將作品上傳到 <a href="https://docs.google.com/forms/d/e/1FAIpQLSfpq4AGg_hFSsRgi4WSBapoL7AFeE7uC0j1yZqP2i9VL6SmaA/viewform" className ='font-bold underline underline-offset-2'>梅竹黑客松成果存放平台</a>，方可領取獎金</p>
                </div>
            </div>
        </div>
