...
const Team_intro = () => {
  ...
  const team_intro_data = [
    {
      ...
      description:
        "我們致力於搭起學生與企業之間的橋樑，學生運用企業資源並發揮潛力回應企業命題，同時企業方更提供實習機會，能讓學生進一步實踐創意發想！而今年我們將由以下六家企業作為引導單位： Google、台積電、恩智浦與文曄科技、LINE、ETtoday、KKCompany",
      link: "/team/hacker",
    },
    {
      team: "創客交流組",
  ...
  return (
    <div id="team_intro">
      <h2 className="w-fit mx-auto text-black hidden md:block py-8">
        組別介紹{" "}
      </h2>
