    ...
    const items = [
        {
            ...
            award:['第一名：新台幣 15,000 元整、實體獎品、實習或實習面試資格',
            '第二名：新台幣 10,000 元整、實體獎品',
            '第三名：新台幣 5,000 元整、實體獎品'],
            dec:''
        },
        {
            block_css:'ml-[1%] w-full',
            team:'創客交流組',
            description:'',
            award:['第一名：新台幣 40,000 元整','第二名：新台幣 30,000 元整','第三名：新台幣 20,000 元整'],
            dec:''
        },
        {
            block_css:'ml-[1%] w-[80%]',
            ...
            award:['第一名：新台幣 28,000 元整','第二名：新台幣 12,000 元整','第三名：新台幣 6,000 元整'],
            dec:'w-[20%] '
        }
    ]
    return(
