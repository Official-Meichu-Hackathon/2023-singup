  ...
  return (
    <>
      <div className="hidden md:block aspect-[1440/800] w-full  relative bg-white">
        <h4 className="absolute title_bg z-10">2023</h4>
        <Waveanimation />
        <div className="absolute mt-3 top-[15%] left-0 z-0"></div>
        ...
        <h4 className="absolute right-[5%] text-[4vw] bottom-[17%] hack_font">
          Oct. 21-22
        </h4>
      ...
      <div className="block md:hidden aspect-[411/725] w-full relative bg-white">
        ...
        <h4 className="absolute right-[5%] text-[6vw] bottom-[21%] hack_font">
          Oct. 21-22
        </h4>
